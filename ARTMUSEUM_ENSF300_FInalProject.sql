...
CREATE TABLE Art_Objects(
	...
	primary key(ID_number, Artist_ID)
    -- foreign key(Artist_ID) references Artist(Artist_ID) ON DELETE CASCADE,
    -- foreign key (Collection_name) references Collections(Col_name) ON DELETE CASCADE
);
...
VALUES
('European Paintings', 'Museum', 'Collection of European paintings from the thirteenth through the early twentieth century','The Met Fifth Avenue', 2125357710, '1000 Fifth Avenue New York'),					
...
( 'The American Wing', 'Personal','Collection of works by African American, Euro American, Native American, and Latin American artists', 'The Met Fifth Avenue', 2125357710, '1000 Fifth Avenue New York'),		
('European Sculpture and Decorative Arts', 'Museum','Museums comprehensive collection of European sculpture and decorative arts', 'The Met Fifth Avenue', 2125357710, '1000 Fifth Avenue New York');			
...
-- ADD CONSTRAINT fk_Object_ID FOREIGN KEY(Object_ID) REFERENCES Art_Objects(ID_number) ON DELETE CASCADE;
...
-- ADD CONSTRAINT fk_ID_number FOREIGN KEY(ID_number) REFERENCES Art_Objects(ID_number) ON DELETE CASCADE;
...
-- ADD CONSTRAINT fk_ID_number FOREIGN KEY(ID_number) REFERENCES Art_Objects(ID_number) ON DELETE CASCADE,
-- ADD CONSTRAINT fk_Collection_from FOREIGN KEY(Collection_from) REFERENCES Collections(Col_name) ON DELETE CASCADE;
